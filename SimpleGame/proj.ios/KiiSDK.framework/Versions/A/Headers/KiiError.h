...
/** Find error codes and messages that can be returned by Kii SDK
 ...
 - *901* - Experiment with specified name is not found.
 - *902* - The experiment has terminated with no specified variation.
 - *903* - The experiment has paused with no specified variation. 
 - *904* - Variation with specified name is not found.
 */
...
/**Experiment with specified name is not found.
 */
