...
/** Generate event dictionary for conversion by given KiiConversionEvent instance.
 ...
 You need to call <KiiAnalytics#trackEvent:withExtras:> and pass experiment name and returned dictionary to send the event to Kii Analytics cloud.
     ...
     [KiiAnalytics trackEvent:[experiment name] withExtras:dict];
 ...
 */
@property(nonatomic,readonly) NSDictionary* testDictionary;
@end
