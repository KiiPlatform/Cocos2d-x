...
public class KRanking {
    ...
    public void displayNameUpdate(String name) {
        ...
        user2.update(new KiiUserCallBack() {
            ...
            public void onUpdateCompleted(int token, KiiUser user, Exception e) {
                MYLog.v(TAG, "displayNameUpdate onUpdateCompleted " + token
                        + " " + user + " " + e);
        ...
        bucket.query(new KiiQueryCallBack<KiiObject>() {
            ...
            public void onQueryCompleted(int arg0,
                ...
                for (KiiObject obj : objLists) {
                    ...
                    MYLog.v(TAG, "ranking_query_all " + name2 + " " + dname
                            + " " + score2);
     ...
     * @param score
     */
    private void ranking_query(KiiBucket bucket, final String name,
            final int score) {
        ...
        bucket.query(new KiiQueryCallBack<KiiObject>() {
            ...
            public void onQueryCompleted(int arg0,
                ...
                for (KiiObject obj : objLists) {
                    ...
                    MYLog.v(TAG, "ranking_query " + name2 + " " + score2 + " "
                            + score3);
                    if (score3 > myScore) {
                        myScore = score3;
                        uri = obj.toUri();
    ...
    private void ranking_save(Uri uri, String name, int score) {
        ...
        object.save(new KiiObjectCallBack() {
            ...
            public void onSaveCompleted(int token, KiiObject object, Exception e) {
                MYLog.v(TAG, "ranking_save onSaveCompleted " + token + " "
                        + object + " " + e);
    ...
    private void ranking_refresh(Uri uri) {
        ...
        object2.refresh(new KiiObjectCallBack() {
            ...
            public void onRefreshCompleted(int token, KiiObject object,
                ...
                String display_name = object.getString(Field.DISPLAYNAME,
                        "null");
                MYLog.v(TAG, "refresh_ranking " + name + " " + display_name
                        + " " + score);
            }
        });
    }
    ...
    public void save() {
        ...
        object.save(new KiiObjectCallBack() {
            @Override
            public void onSaveCompleted(int token, KiiObject object, Exception e) {
                MYLog.v(TAG, "save onSaveCompleted " + token + " " + object
                        + " " + e);
                Uri uri = object.toUri();
                refresh(uri);
            }
    ...
    private void refresh(Uri uri) {
        ...
        object2.refresh(new KiiObjectCallBack() {
            ...
            public void onRefreshCompleted(int token, KiiObject object,
                    Exception e) {
                MYLog.v(TAG, "refresh onRefreshCompleted " + token + " "
                        + object + " " + e);
    ...
    public void login(String userName, String passWord) {
        ...
        KiiUser.logIn(new KiiUserCallBack() {
            @Override
            public void onLoginCompleted(int token, KiiUser user, Exception e) {
                MYLog.v(TAG, "login onLoginCompleted " + token + " " + user
                        + " " + e);
                // save();
                m_username = username;
                m_appRankingBucket = Kii.bucket(Field.B_RANKING); // B_RANKING
    ...
    public void regist(String userName, String passWord) {
        ...
        user.register(new KiiUserCallBack() {
            ...
            public void onRegisterCompleted(int token, KiiUser user, Exception e) {
                ...
                MYLog.v(TAG, "m_username " + m_username);
                Pref.setStoredAccessToken(m_simpleGame.getApplicationContext(),
                        token2);
                Pref.setUSERNAME(m_simpleGame.getApplicationContext(),
                        m_username);
