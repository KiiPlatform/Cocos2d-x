...
bool PName::init()
{
    ...
    EditBox* pEditBox = EditBox::create(editBoxSize, Scale9Sprite::create("sprite9.png"));
...
void PName::editBoxEditingDidBegin(EditBox* editBox) {
    CCLOG("did begin");
}

void PName::editBoxEditingDidEnd(EditBox* editBox) {
...
void PName::editBoxTextChanged(EditBox* editBox, const std::string& text) {
    CCLOG("change %s", text.c_str());
}

void PName::editBoxReturn(EditBox* editBox) {
    CCLOG("return");
}
