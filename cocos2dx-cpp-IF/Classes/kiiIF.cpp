...
extern "C"
{
	...
	//JNIEXPORT void JNICALL Java_org_cocos2dx_simplegame_CallCPP_setDisplayame
	JNIEXPORT void JNICALL Java_com_hoge_myapp_CallCPP_setDisplayame2
	(JNIEnv *env, jobject obj, jstring str1, jint serviceID) {
	    CCLOG("Java_org_cocos2dx_simplegame_CallCPP_setDisplayame2");
	...
	JNIEXPORT void JNICALL Java_com_hoge_myapp_CallCPP_kiiRes3
	(JNIEnv *env, jobject obj, jstring str1) {
	    CCLOG("Java_org_cocos2dx_simplegame_CallCPP_kiiRes3");
	...
	JNIEXPORT void JNICALL Java_com_hoge_myapp_CallCPP_kiiRes2
	(JNIEnv *env, jobject obj, jstring str1) {
	    CCLOG("Java_com_hoge_myapp_CallCPP_kiiRes2");
	...
	JNIEXPORT void JNICALL Java_com_hoge_myapp_CallCPP_kiiRes
	(JNIEnv *env, jobject obj, jstring str1, jint serviceID) {
	    CCLOG("Java_com_hoge_myapp_CallCPP_kiiRes");
